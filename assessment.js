...
message["text"] = "This is some text."// CODE HERE
...
console.log(adjustCount.upVote(5));
console.log(adjustCount.downVote(5));
// #5 Create an array called 'myFriends' with four of your friends names

var myFriends = ["Scual", "Peter", "Weez", "Chris"]// CODE HERE
console.log(myFriends);

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("Howard")// CODE HERE
console.log(myFriends);
